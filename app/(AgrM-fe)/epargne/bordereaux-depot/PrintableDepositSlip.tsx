...
const PrintableDepositSlip = forwardRef<HTMLDivElement, PrintableDepositSlipProps>(
    ({ depositSlip, companyName = "MICROFINANCE", companyAddress = "Bujumbura, Burundi", companyPhone = "+257 22 69 21 01 93" }, ref) => {

        const slipCurrencyCode = (depositSlip as any).currency?.code || (depositSlip as any).savingsAccount?.currency?.code || 'FBU';
        ...
        const isGroup = !!(depositSlip as any).solidarityGroup;
        const getClientName = () => {
            if (isGroup) return (depositSlip as any).solidarityGroup?.groupName || (depositSlip as any).solidarityGroup?.name || '-';
                        ...
                        <table style={{ width: '100%', fontSize: '11px' }}>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style={{ padding: '3px 0', fontWeight: 'bold' }}>{(depositSlip as any).savingsAccount?.accountNumber || (depositSlip as any).accountNumber || '-'}</td>
                                </tr>
                                <tr>
