...
import PrintableEngagementReceipt from './PrintableEngagementReceipt';
...
function AttestationEngagementPage() {
    ...
    useEffect(() => {
        if (actionsApi.data) {
            switch (actionsApi.callType) {
                case 'create':
                    showToast('success', 'Succes', 'Demande d\'attestation d\'engagement creee avec succes');
                    resetForm();
                    loadRequests();
                    setActiveIndex(1);
                    break;
    ...
    const activeCredits = clientCredits.filter(c => c.remainingBalance > 0);
    ...
    const handleSubmit = () => {
        ...
        const engagementSummary = activeCredits.length > 0
            ? `${clientCredits.length} credit(s) dont ${activeCredits.length} en cours`
            : clientCredits.length > 0
                ? `${clientCredits.length} credit(s) tous rembourses`
                : 'Compte epargne actif, aucun credit';
        ...
        const requestData = {
            ...
            feeAmount: feeAmount,
            motif: motif || 'Demande d\'attestation d\'engagement',
            notes: notes + ` | ENGAGEMENT: ${engagementSummary}`,
    ...
    const header = (
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <h5 className="m-0">Demandes d'Attestation d'Engagement</h5>
    ...
    return (
        <div className="card">
                ...
                <div className="grid">
                    ...
                    <div className="col-12 md:col-4">
                        <div className="flex align-items-center gap-2">
                            ...
                            <span><strong>Verification:</strong> Compte, Credits actifs</span>
                        </div>
                    </div>
                    <div className="col-12 md:col-4">
                        <div className="flex align-items-center gap-2">
                            <i className="pi pi-info-circle text-green-500"></i>
                            <span><strong>Cycle:</strong> Verification &rarr; Creation &rarr; Validation &rarr; Livraison</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        {verifying && (
                            <div className="col-12">
                                <div className="flex align-items-center justify-content-center gap-3 p-4">
                                    ...
                                    <span className="text-600">Verification du compte et des credits en cours...</span>
                                </div>
                            </div>
                        )}
                        ...
                        {verificationDone && (
                            <div className="col-12">
                                <div className="p-3 border-round mb-3 bg-blue-50 border-blue-200 border-1">
                                    <h5 className="mb-3">
                                        <i className="pi pi-check-circle text-blue-600 mr-2"></i>
                                    ...
                                    <div className="grid mb-3">
                                        <div className="col-12 md:col-4">
                                            <Message
                                                severity="success"
                                                text="Compte epargne actif"
                                                className="w-full"
                                            />
                                        </div>
                                        <div className="col-12 md:col-4">
                                            <Message
                                                severity={clientCredits.length > 0 ? 'info' : 'info'}
                                                text={clientCredits.length > 0 ? `${clientCredits.length} credit(s) obtenus` : 'Aucun credit'}
                                                className="w-full"
                                            />
                                        </div>
                                        <div className="col-12 md:col-4">
                                            <Message
                                                severity={activeCredits.length > 0 ? 'warn' : 'success'}
                                                text={activeCredits.length > 0 ? `${activeCredits.length} credit(s) en cours` : 'Aucun credit en cours'}
                                                className="w-full"
                                            />
                                        </div>
                                    </div>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <DataTable value={clientCredits} size="small" stripedRows showGridlines>
                                                ...
                                                <Column header="Reste a Payer" body={(row) => (
                                                    <span className={row.remainingBalance > 0 ? 'text-blue-600 font-bold' : 'text-green-600 font-bold'}>
                                                        {formatCurrency(row.remainingBalance)}
                                                    </span>
                                                )} />
                                                <Column header="Statut" body={(row) => (
                                                    <Tag
                                                        value={row.remainingBalance > 0 ? 'En cours' : 'Rembourse'}
                                                        severity={row.remainingBalance > 0 ? 'warning' : 'success'}
                                                    />
                                                )} />
                                            </DataTable>
                                        </div>
                                    ...
                                    <div className="formgrid grid">
                                        ...
                                        <div className="field col-12 md:col-5">
                                            ...
                                            <InputText
                                                ...
                                                placeholder="Demande d'attestation d'engagement"
                                                className="w-full"
                                            />
                                        </div>
            ...
            {/* Print Dialog */}
            <Dialog header="Apercu de l'Attestation d'Engagement" visible={printDialog} style={{ width: '950px' }} onHide={() => setPrintDialog(false)}
