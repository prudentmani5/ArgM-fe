...
const RapportDemandesSituationPage = () => {
    ...
    const exportToExcel = () => {
        ...
        const link = document.createElement('a'); link.href = URL.createObjectURL(blob); link.download = `rapport_demandes_situation_${formatLocalDate(new Date())}.csv`; link.click();
    };
