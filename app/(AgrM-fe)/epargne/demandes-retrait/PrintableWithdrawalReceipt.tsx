...
const PrintableWithdrawalReceipt = forwardRef<HTMLDivElement, PrintableWithdrawalReceiptProps>(
    ({ withdrawal, companyName = "MICROFINANCE", companyAddress = "Bujumbura, Burundi", companyPhone = "+257 22 69 21 01 93" }, ref) => {
        ...
        const slipCurrencyCode = (withdrawal as any).currency?.code || (withdrawal as any).savingsAccount?.currency?.code || 'BIF';
        ...
        const getBranchName = () => withdrawal.branch?.name || '-';

        const getAccountNumber = () =>
            (withdrawal as any).savingsAccount?.accountNumber || withdrawal.savingsAccountId || '-';
        ...
        return (
            <div ref={ref} className="printable-receipt" style={{
                        ...
                        <table style={{ width: '100%', fontSize: '11px' }}>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style={{ padding: '3px 0', fontWeight: 'bold' }}>{getAccountNumber()}</td>
                                </tr>
                                <tr>
                        ...
                        <table style={{ width: '100%', fontSize: '11px' }}>
                            <tbody>
                                ...
                                {withdrawal.disbursementDate && (
                                    <tr>
                                        <td style={{ padding: '3px 0', color: '#666' }}>Date décaissement:</td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style={{ padding: '3px 0', fontWeight: 'bold', width: '25%' }}>
                                        {withdrawal.depositorRelationship === 'TITULAIRE' ? 'Titulaire du compte' : withdrawal.depositorRelationship || '-'}
                                    </td>
                                </tr>
                                <tr>
                                    <td style={{ padding: '3px 0', color: '#666' }}>Téléphone:</td>
                                    <td style={{ padding: '3px 0', fontWeight: 'bold' }}>{withdrawal.depositorPhone || '-'}</td>
                                    <td style={{ padding: '3px 0', color: '#666' }}>N° Pièce d'identité:</td>
                ...
                {/* Cash Denominations */}
                {withdrawal.cashDenominations && withdrawal.cashDenominations.length > 0 && (
                    <div style={{ border: '1px solid #ddd', borderRadius: '5px', padding: '12px', marginBottom: '20px', backgroundColor: '#fff' }}>
                        <h3 style={{ margin: '0 0 10px 0', fontSize: '13px', color: '#1e3a8a', borderBottom: '1px solid #ddd', paddingBottom: '5px' }}>
                        ...
                        <table style={{ width: '100%', fontSize: '11px', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                {withdrawal.cashDenominations.map((denom, index) => (
                ...
                <div style={{ border: '2px solid #1e3a8a', borderRadius: '5px', padding: '15px', marginBottom: '20px', backgroundColor: '#eff6ff' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div>
                            <table style={{ fontSize: '12px' }}>
                                <tbody>
                                    ...
                                    <tr>
                                        <td style={{ padding: '3px 15px 3px 0', color: '#666' }}>Solde après retrait:</td>
                        ...
                        <div style={{ textAlign: 'right' }}>
                            <p style={{ margin: 0, fontSize: '12px', color: '#666' }}>MONTANT RETIRÉ</p>
                ...
                <div style={{ marginTop: '20px', paddingTop: '10px', borderTop: '1px solid #eee', textAlign: 'center', fontSize: '9px', color: '#999' }}>
                    <p style={{ margin: 0 }}>Ce document est un reçu officiel de retrait. Veuillez le conserver précieusement.</p>
