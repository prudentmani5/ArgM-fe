                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={styles.value}>
                            {formatNumberTonnage(finalTonnageArrondi)} × {formatCurrency(invoice.manutBateau/invoice.tarifBarge)} = {formatCurrency(invoice.manutBateau)}
                        </Text>
                    </View>
                            ...
                            {invoice.typeConditionId === 'VE' ? (
                                ...
                                <>
                                    <Text style={styles.calculLine}>
                                        {formatNumber(finalTonnageArrondi)} × {formatCurrency(prixUnitaireMagasin)} × {invoice.duree || 0} Jours  = {formatCurrency(montantMagasin)}
                                    </Text>
                                    {invoice.duree37 > 0 && (
                                        <Text style={styles.calculLine}>
                                            {formatNumber(finalTonnageArrondi)} × {formatCurrency(prixUnitaireMagasin37)} × {invoice.duree37} Jours  = {formatCurrency(montantMagasin37)}
                                        </Text>
                                    )}
                                </>
                            ) : (
