    ...
    const handleGenerate = async (values: { dateDebut: Date; dateFin: Date }) => {
        ...
        try {
            ...
            const response = await fetch(
                `${API_BASE_URL}/factueUserSaisis/genererNonEncaisse?dateDebut=${debut}&dateFin=${fin}`,
                { 
                    method: 'POST',
                    headers: {
        ...
        <div className="p-4">
            ...
            <div className="mb-6">
                <div className="flex align-items-center mb-3">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-900 m-0">Rapport de toutes factures non encaissées</h1>
            ...
            <Card className="shadow-2 border-round-xl">
                <div className="flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 className="text-2xl font-bold text-900 m-0">📋 Liste des Factures encaissées</h2>
