...
const InvoiceForm: React.FC<InvoiceFormProps> = ({
    ...
    return (
        <div className="card p-fluid">
            {/* Section des boutons de calcul et impression */}
            <div className="formgrid grid">
                ...
                <div className="field col-3 flex justify-content-end">
                    <Button
                        ...
                        type="button"
                        tooltip="Générer la facture proforma"
                        tooltipOptions={{ position: 'top' }}
                        disabled={!invoice.montantPaye || invoice.montantPaye === 0}
                    />
                </div>

                {/* Bouton Facture Validée 
                <div className="field col-3 flex justify-content-end">
                    <Button
                        label="Imprimer Facture Validée"
                        icon="pi pi-print"
                        onClick={handlePrintInvoice}
                        className="p-button-help"
                        type="button"
                        tooltip="Ouvrir la facture validée pour impression"
                        tooltipOptions={{ position: 'top' }}
                        disabled={!invoice.montantPaye || invoice.montantPaye === 0}
            ...
            <div className="formgrid grid">
                ...
                <div className="field col-3">
                    ...
                    <InputNumber
                        ...
                        value={invoice.surtaxeColisLourd || 0}
                ...
                <div className="field col-3">
                    <label htmlFor="montMagasinage37">Montant Magasinage 37</label>
                    <InputNumber
                        id="montMagasinage37"
                        name="montMagasinage37"
                        value={invoice.montMagasinage37}
                        onValueChange={(e) => handleNumberChange('montMagasinage37', e.value ?? 0)}
                        mode="currency"
                        currency="BIF"
                        locale="fr-MG"
                        //readOnly
                ...
                <div className="field col-3">
                 ...
                 <div className="field col-3">
                    <label htmlFor="duree37">Durée 37</label>
                    <InputNumber
                        id="duree37"
                        name="duree37"
                        value={invoice.duree37}
