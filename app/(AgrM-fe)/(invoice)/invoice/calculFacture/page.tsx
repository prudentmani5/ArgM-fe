...
import { PDFComponentType } from './pdfTypes';
    ...
    const handleCalculate = async (endpointType: 'menutention' | 'supplement' | 'solde' = 'menutention'): Promise<ManutentionResult> => {
        ...
        try {
            ...
            setInvoice(prev => ({
                ...
                montGardienage37: result.montantGardiennage37 || 0,
                montMagasinage: result.montantMagasinage,
                montMagasinage37: result.montantMagasinage37 || 0,
                ...
                dateSupplement: result.typeFacture === 'Supplement' ? result.dateSortie : prev.dateSupplement,
                dateDerniereSortie: result.typeFacture === 'Solde' ? result.dateSortie : prev.dateDerniereSortie,
