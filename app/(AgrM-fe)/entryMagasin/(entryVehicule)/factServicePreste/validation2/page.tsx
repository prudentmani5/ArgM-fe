...
function FacServicePresteComponent() {
    ...
    const handleSubmitEdit = () => {
        setBtnLoading(true);
        facServicePresteEdit.valide2 = true;
    ...
    const fectAllFacServicePreste = () => {
        fetchData(null, 'GET', `${BASE_URL}/findFacServicePresteForValidate2?numFacture=${encodeURIComponent(numFacture)}&validation=false`, 'loadFacServicesPreste');
    ...
    return (
        <>
            <Toast ref={toast} />
            <Dialog
                header="Validation second niveau"
