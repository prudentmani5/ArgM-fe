...
interface FacServicePresteResultProps {
    ...
    results: FacServicePresteEntree[];
    loading: boolean;
    onSelect: (facture: FacServicePresteEntree) => void;
    onClear: () => void;
    onDelete?: (service: FacServicePresteEntree) => void;
    onEdit?: (service: FacServicePresteEntree) => void;
    services?: FacService[];
    isEditMode?: boolean;
}
...
const FacServicePresteResult: React.FC<FacServicePresteResultProps> = ({
    ...
    const handleDelete = (rowData: FacServicePresteEntree) => {
...
Montant: ${formatCurrency(rowData.montant)} FBU`,
    ...
    const actionBodyTemplate = (rowData: FacServicePresteEntree) => {
        return (
