                ...
                <AccordionTab
                    header={
                        <span className="flex align-items-center gap-2">
                            ...
                            <span className="font-bold">13. Tableaux de Bord</span>
                        </span>
                    }
                >
                    <div className="p-3">
                        <p className="line-height-3">
                            Le module Tableaux de Bord offre une vision consolidée de la performance de l'institution en temps réel.
                            Chaque profil utilisateur dispose d'un tableau de bord adapté à ses responsabilités, avec des indicateurs clés de performance (KPIs),
                            des graphiques interactifs et des alertes visuelles.
                        </p>

                        <h5 className="text-primary">13.1 Accès aux Tableaux de Bord</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <p><strong>Navigation :</strong></p>
                            <ol className="line-height-3">
                                <li>Dans le menu principal, cliquer sur <Tag value="Tableaux de Bord" /></li>
                                <li>Sélectionner le tableau de bord correspondant à votre profil :
                                    <ul>
                                        <li><Tag value="Direction Générale" severity="info" /> - Vue globale de l'institution</li>
                                        <li><Tag value="Chef d'Agence" severity="info" /> - Performance de l'agence</li>
                                        <li><Tag value="Opérations Crédit" severity="info" /> - Suivi du portefeuille crédit</li>
                                        <li><Tag value="Comptabilité" severity="info" /> - Situation comptable et trésorerie</li>
                                    </ul>
                                </li>
                                <li>L'accès à chaque tableau de bord est contrôlé par les permissions :
                                    <ul>
                                        <li><code>DASHBOARD_DG_VIEW</code> - Direction Générale</li>
                                        <li><code>DASHBOARD_BRANCH_MANAGER_VIEW</code> - Chef d'Agence</li>
                                        <li><code>DASHBOARD_CREDIT_OPS_VIEW</code> - Opérations Crédit</li>
                                        <li><code>DASHBOARD_ACCOUNTING_VIEW</code> - Comptabilité</li>
                                    </ul>
                                </li>
                            </ol>
                        </div>

                        <h5 className="text-primary">13.2 Filtres Communs</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <p>Chaque tableau de bord dispose de filtres pour personnaliser la vue :</p>
                            <ul className="line-height-3">
                                <li><strong>Date début / Date fin :</strong> Définir la période d'analyse. Par défaut, les 12 derniers mois sont sélectionnés.</li>
                                <li><strong>Agence :</strong> Filtrer par agence (disponible pour DG et Opérations Crédit). Le Chef d'Agence voit uniquement son agence.</li>
                                <li>Cliquer sur <Tag value="Appliquer" severity="success" /> pour rafraîchir les données avec les filtres sélectionnés.</li>
                            </ul>
                            <div className="mt-2 p-2 border-round" style={{ backgroundColor: '#fff3cd' }}>
                                <i className="pi pi-exclamation-triangle mr-2 text-yellow-700"></i>
                                <strong>Conseil :</strong> Pour une analyse précise, assurez-vous que la période sélectionnée correspond à l'exercice en cours.
                            </div>
                        </div>

                        <h5 className="text-primary">13.3 Tableau de Bord - Direction Générale</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <p>Ce tableau de bord offre une vue d'ensemble complète de l'institution avec les sections suivantes :</p>
                            ...
                            <div className="grid mt-3">
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-blue-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Membres actifs :</strong> Nombre total de clients actifs</li>
                                            <li><strong>Nouveaux ce mois :</strong> Membres inscrits ce mois avec tendance vs mois précédent</li>
                                            <li><strong>Emprunteurs actifs :</strong> Clients ayant un crédit en cours</li>
                                            <li><strong>Épargnants actifs :</strong> Clients ayant un compte d'épargne actif</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-green-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Encours brut :</strong> Capital restant dû total</li>
                                            <li><strong>Encours net :</strong> Encours brut moins les provisions</li>
                                            <li><strong>PAR {'>'}1j / {'>'}30j / {'>'}90j :</strong> Portefeuille à risque par tranche de retard</li>
                                            <li><strong>Taux de défaut :</strong> Ratio des crédits en défaut</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-purple-500">
                                        <h6 className="text-purple-500 mt-0">
                                            <i className="pi pi-database mr-2"></i>
                                            Épargne
                                        </h6>
                                        <ul className="line-height-3">
                                            <li><strong>Total épargne :</strong> Solde total des comptes d'épargne</li>
                                            <li><strong>Épargne libre :</strong> Épargne volontaire</li>
                                            <li><strong>Épargne obligatoire :</strong> Épargne liée aux crédits</li>
                                            <li><strong>Dépôts à terme :</strong> DAT en cours</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-orange-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Produits / Charges :</strong> Revenus et dépenses comptables</li>
                                            <li><strong>Résultat net :</strong> Produits moins charges</li>
                                            <li><strong>Autosuffisance opérationnelle :</strong> Ratio produits/charges</li>
                                            <li><strong>ROA / ROE :</strong> Rendement des actifs et capitaux propres</li>
                                        </ul>
                                    </Card>
                                </div>
                            </div>

                            <p className="mt-3"><strong>Graphiques :</strong></p>
                            <ul className="line-height-3">
                                <li><strong>Décaissements vs Remboursements :</strong> Graphique en barres montrant l'évolution mensuelle des décaissements et remboursements</li>
                                <li><strong>Répartition Épargne :</strong> Diagramme circulaire de la répartition par type d'épargne</li>
                            </ul>
                            <p><strong>Tableau Performance par Agence :</strong> Classement des agences avec nombre de membres, encours crédit, volume épargne et PAR {'>'}30j</p>
                        </div>

                        <h5 className="text-primary">13.4 Tableau de Bord - Chef d'Agence</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <p>Ce tableau de bord est centré sur la performance d'une agence spécifique.</p>
                            ...
                            <div className="grid mt-3">
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-red-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Décaissements du jour :</strong> Nombre et montant total</li>
                                            <li><strong>Remboursements du jour :</strong> Nombre et montant total</li>
                                            <li><strong>Nouveaux membres :</strong> Inscriptions du jour</li>
                                        </ul>
                                        <div className="mt-2 p-2 border-round" style={{ backgroundColor: '#d4edda' }}>
                                            <i className="pi pi-info-circle mr-2 text-green-700"></i>
                                            Cette section se met à jour en temps réel à chaque rechargement.
                                        </div>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-blue-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Membres actifs :</strong> Total des clients de l'agence</li>
                                            <li><strong>Nouveaux ce mois :</strong> Avec tendance (flèche verte/rouge)</li>
                                            <li><strong>Emprunteurs / Épargnants :</strong> Clients actifs par produit</li>
                                        </ul>
                                    </Card>
                                </div>
                            </div>

                            <p className="mt-3"><strong>Sections additionnelles :</strong></p>
                            <ul className="line-height-3">
                                <li><strong>Portefeuille Crédit :</strong> Encours brut/net, décaissé/remboursé sur la période, PAR par tranche</li>
                                <li><strong>Épargne de l'Agence :</strong> Total et répartition par type</li>
                                <li><strong>Graphique :</strong> Décaissements vs Remboursements mensuels</li>
                                <li><strong>Pipeline Crédit :</strong> Diagramme des demandes par étape (Reçues, En analyse, Approuvées, Rejetées)</li>
                            </ul>

                            <div className="mt-2 p-2 border-round" style={{ backgroundColor: '#fff3cd' }}>
                                <i className="pi pi-exclamation-triangle mr-2 text-yellow-700"></i>
                                <strong>Important :</strong> Le Chef d'Agence doit obligatoirement sélectionner son agence dans le filtre. Le système sélectionne automatiquement la première agence disponible.
                            </div>
                        </div>

                        <h5 className="text-primary">13.5 Tableau de Bord - Opérations Crédit</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <p>Ce tableau de bord est destiné au responsable des opérations crédit.</p>
                            ...
                            <div className="grid mt-3">
                                <div className="col-12 md:col-4">
                                    <Card className="h-full border-left-3 border-blue-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li>Demandes reçues sur la période</li>
                                            <li>Demandes en cours d'analyse</li>
                                            <li>Demandes approuvées / rejetées</li>
                                            <li>Montant total demandé et approuvé</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-4">
                                    <Card className="h-full border-left-3 border-orange-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li>Encours brut et net</li>
                                            <li>PAR {'>'}1j, {'>'}30j, {'>'}90j</li>
                                ...
                                <div className="col-12 md:col-4">
                                    <Card className="h-full border-left-3 border-red-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li>Montant total en retard</li>
                                            <li>Nombre de clients en retard</li>
                                            <li>Crédits restructurés</li>
                                            <li>Dossiers en contentieux</li>
                                            <li>Taux de recouvrement</li>
                                        </ul>
                                    </Card>
                                </div>
                            ...
                            <p className="mt-3"><strong>Graphiques :</strong></p>
                            <ul className="line-height-3">
                                <li><strong>Pipeline (barres horizontales) :</strong> Nombre de demandes par étape</li>
                                <li><strong>PAR par agence :</strong> Comparaison de la qualité du portefeuille entre agences</li>
                            </ul>
                            <p><strong>Tableau Top 10 Débiteurs :</strong> Liste des plus gros impayés avec nom, montant en retard, jours de retard et agence</p>
                        </div>

                        <h5 className="text-primary">13.6 Tableau de Bord - Comptabilité</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <p>Ce tableau de bord présente la situation comptable et financière de l'institution.</p>
                            ...
                            <div className="grid mt-3">
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-blue-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Total Actif :</strong> Classes 1-5 (débit - crédit)</li>
                                            <li><strong>Total Passif :</strong> Classes 1-5 (crédit - débit)</li>
                                            <li><strong>Équilibre :</strong> Différence actif-passif (doit être proche de zéro)</li>
                                            <li><strong>Nombre d'écritures :</strong> Total des écritures de l'exercice</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-green-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Caisse (57x) :</strong> Solde des comptes caisse</li>
                                            <li><strong>Banque (52x) :</strong> Solde des comptes bancaires</li>
                                            <li><strong>Trésorerie nette :</strong> Caisse + Banque</li>
                                            <li><strong>Ratio liquidité :</strong> Trésorerie / Passif courant</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-orange-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Écritures non validées :</strong> En attente de validation</li>
                                            <li><strong>Rapprochement en attente :</strong> Écritures non rapprochées</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-6">
                                    <Card className="h-full border-left-3 border-purple-500">
                                        ...
                                        <ul className="line-height-3">
                                            <li><strong>Produits (Classe 7) :</strong> Total des revenus</li>
                                            <li><strong>Charges (Classe 6) :</strong> Total des dépenses</li>
                                            <li><strong>Résultat net :</strong> Produits - Charges</li>
                                        </ul>
                                    </Card>
                                </div>
                            </div>
                            ...
                            <p className="mt-3"><strong>Graphiques :</strong></p>
                            <ul className="line-height-3">
                                <li><strong>Produits vs Charges :</strong> Graphique en barres mensuel comparant revenus et dépenses</li>
                                <li><strong>Répartition des Charges :</strong> Diagramme circulaire par catégorie de charge</li>
                            </ul>
                            <p><strong>Tableau Balance :</strong> Résumé par compte comptable avec débit, crédit et solde</p>

                            <div className="mt-2 p-2 border-round" style={{ backgroundColor: '#cce5ff' }}>
                                <i className="pi pi-info-circle mr-2 text-blue-700"></i>
                                <strong>Note :</strong> Le tableau de bord comptable n'a pas de filtre par agence car les écritures comptables sont centralisées au niveau de l'institution.
                            </div>
                        </div>

                        <h5 className="text-primary">13.7 Comprendre les Indicateurs Clés</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <h6><i className="pi pi-chart-line mr-2"></i>Indicateurs de Risque Crédit</h6>
                            <div className="grid mt-2">
                                <div className="col-12 md:col-4">
                                    <Card className="h-full">
                                        <h6 className="mt-0">PAR (Portefeuille à Risque)</h6>
                                        <p className="line-height-3">
                                            Le PAR mesure la qualité du portefeuille crédit. Il représente le pourcentage de l'encours
                                            total dont au moins une échéance est en retard de plus de N jours.
                                        </p>
                                        <ul>
                                            <li><span style={{ color: '#22c55e', fontWeight: 'bold' }}>PAR {'<'} 5%</span> - Excellent</li>
                                            <li><span style={{ color: '#f97316', fontWeight: 'bold' }}>PAR 5-10%</span> - Attention requise</li>
                                            <li><span style={{ color: '#ef4444', fontWeight: 'bold' }}>PAR {'>'} 10%</span> - Critique</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-4">
                                    <Card className="h-full">
                                        <h6 className="mt-0">Tendances (flèches)</h6>
                                        <p className="line-height-3">
                                            Les indicateurs avec flèches montrent l'évolution par rapport au mois précédent :
                                        </p>
                                        <ul>
                                            <li><span style={{ color: '#22c55e' }}><i className="pi pi-arrow-up"></i> +X%</span> - Hausse (positif pour membres, négatif pour PAR)</li>
                                            <li><span style={{ color: '#ef4444' }}><i className="pi pi-arrow-down"></i> -X%</span> - Baisse</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-4">
                                    <Card className="h-full">
                                        <h6 className="mt-0">Codes Couleur</h6>
                                        <p className="line-height-3">
                                            Les cartes KPI utilisent un code couleur pour signaler l'état :
                                        </p>
                                        <ul>
                                            <li><span style={{ color: '#22c55e', fontWeight: 'bold' }}>Vert</span> - Situation saine</li>
                                            <li><span style={{ color: '#f97316', fontWeight: 'bold' }}>Orange</span> - Vigilance nécessaire</li>
                                            <li><span style={{ color: '#ef4444', fontWeight: 'bold' }}>Rouge</span> - Action urgente requise</li>
                                        </ul>
                                    </Card>
                                </div>
                            </div>
                        ...
                        <h5 className="text-primary">13.8 Bonnes Pratiques</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <div className="grid">
                                <div className="col-12 md:col-6">
                                    <Card className="h-full">
                                        ...
                                        <ul className="line-height-3">
                                            <li>Consulter le tableau de bord <strong>quotidiennement</strong> en début de journée</li>
                                            <li>Surveiller les indicateurs PAR et agir dès que les seuils sont dépassés</li>
                                            <li>Comparer les performances entre agences pour identifier les bonnes pratiques</li>
                                            <li>Utiliser les filtres de période pour analyser les tendances trimestrielles et annuelles</li>
                                            <li>Pour le Chef d'Agence : vérifier les opérations du jour avant la clôture</li>
                                        </ul>
                                    </Card>
                                </div>
                                <div className="col-12 md:col-6">
                                    <Card className="h-full">
                                        ...
                                        <ul className="line-height-3">
                                            <li>Ne pas ignorer les indicateurs en rouge : ils signalent un risque immédiat</li>
                                            <li>Les données dépendent de la saisie régulière des opérations dans les autres modules</li>
                                            <li>S'assurer que la clôture journalière est effectuée pour des données à jour</li>
                                            <li>Les ratios comptables (ROA, ROE) ne sont significatifs qu'en fin d'exercice</li>
                                        </ul>
                                    </Card>
                                </div>
                            </div>
                        ...
                        <h5 className="text-primary">13.9 FAQ - Tableaux de Bord</h5>
                        <div className="surface-100 p-3 border-round mb-3">
                            <Accordion>
                                <AccordionTab header="Je ne vois pas le menu Tableaux de Bord, que faire ?">
                                    <p>Le menu n'apparaît que si votre rôle dispose d'au moins une permission de type DASHBOARD. Contactez votre administrateur pour qu'il vous attribue la permission correspondante (ex : <code>DASHBOARD_BRANCH_MANAGER_VIEW</code> pour le Chef d'Agence).</p>
                                </AccordionTab>
                                <AccordionTab header="Les données affichées semblent incorrectes ou incomplètes">
                                    <p>Vérifiez les points suivants : (1) La période sélectionnée est correcte ; (2) L'agence sélectionnée est la bonne ; (3) Les opérations ont bien été saisies et validées dans les modules correspondants ; (4) La clôture journalière a été effectuée. Les tableaux de bord agrègent les données en temps réel à partir des autres modules.</p>
                                </AccordionTab>
                                <AccordionTab header="Que signifie PAR > 30j ?">
                                    <p>Le PAR (Portefeuille à Risque) à 30 jours représente le pourcentage de l'encours total de crédit pour lequel au moins une échéance est impayée depuis plus de 30 jours. Par exemple, un PAR {'>'}30j de 5% signifie que 5% de votre portefeuille est à risque. Les normes internationales de microfinance recommandent de maintenir le PAR {'>'}30j en dessous de 5%.</p>
                                </AccordionTab>
                                <AccordionTab header="Comment exporter les données du tableau de bord ?">
                                    <p>Actuellement, les données sont consultables à l'écran. Pour les rapports détaillés avec export, utilisez les modules de rapports spécifiques (rapports crédit, rapports épargne, rapports comptables) qui offrent des options d'export PDF et Excel.</p>
                                </AccordionTab>
                                <AccordionTab header="À quelle fréquence les données sont-elles mises à jour ?">
                                    <p>Les données sont calculées en temps réel à chaque chargement du tableau de bord. Cliquez sur <Tag value="Appliquer" severity="success" /> pour rafraîchir les indicateurs. Les données reflètent l'état actuel des opérations saisies et validées dans le système.</p>
                                </AccordionTab>
                            </Accordion>
                        </div>
                    </div>
