...
const RecetteCREDITPdf: React.FC<RecetteCREDITPdfProps> = ({ 
    ...
    //const totalHTVA_TT = totalTT - totalExo; // HTVA = TT - Exo
    //const totalTVA_TT = totalExo; // Si Exo représente la TVA

    return (
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <Text style={styles.title}>Rapport des recettes CREDIT</Text>
