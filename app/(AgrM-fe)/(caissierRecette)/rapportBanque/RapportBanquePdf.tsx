...
import { RapportBanqueGrouped } from './RapportBanque';
...
interface RapportBanquePdfProps {
    data: RapportBanqueGrouped[];
    dateDebut: Date;
    dateFin: Date;
    banqueNom: string;
}

const RapportBanquePdf: React.FC<RapportBanquePdfProps> = ({ data, dateDebut, dateFin, banqueNom }) => {
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <Text style={styles.title}>Rapport Banque</Text>
                    <Text style={styles.subtitle}>Banque: {banqueNom}</Text>
                ...
                {data.map((group, index) => (
                    <View key={index} style={{ marginBottom: 15 }}>
                        <Text style={{ fontWeight: 'bold', marginBottom: 5 }}>
                            Banque: {group.libelleBanque} - Total: {formatCurrency(group.total)}
                        </Text>
                        
                        <View style={styles.table}>
                            <View style={styles.tableHeader}>
                                <Text style={styles.tableColHeader}>Date</Text>
                                <Text style={styles.tableColHeader}>No Facture</Text>
...
export default RapportBanquePdf;