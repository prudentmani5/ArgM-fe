...
interface RapportCaissierTotalFormProps {
    onSearch: (values: { dateDebut: Date; dateFin: Date }) => void;
    loading: boolean;
}

const RapportCaissierTotalForm: React.FC<RapportCaissierTotalFormProps> = ({ onSearch, loading }) => {
...
export default RapportCaissierTotalForm;