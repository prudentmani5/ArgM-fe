        ...
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <Text style={styles.title}>Rapport par Date</Text>
                ...
                <View style={styles.tableHeader}>
                                ...
                                <Text style={styles.tableColHeader}>Montant HTVA</Text>
                                <Text style={styles.tableColHeader}>Montant HTVA</Text>
                                <Text style={styles.tableColHeader}>Montant HTVA</Text>
                            </View>
                    ...
                    <View key={index}>
                        ...
                        <View style={styles.table}>
                            <View style={styles.tableRow}>
                                    ...
                                    <Text style={styles.tableCol}>
                                        {formatCurrency(dateGroup.totalHTVA)}

                                    </Text>

                                    <Text style={styles.tableCol}>
                                        {formatCurrency(dateGroup.totalTVA)}
