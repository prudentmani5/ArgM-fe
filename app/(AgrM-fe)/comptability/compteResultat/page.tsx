...
const CompteResultatReport: React.FC = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const response = await fetch(buildApiUrl(`/api/comptability/reports/compte_resultat?${params.toString()}`), {
            ...
            toast.current?.show({ severity: 'success', summary: 'Succès', detail: 'Rapport Compte de Résultat généré avec succès', life: 3000 });
        } catch (err: any) {
...
export default CompteResultatReport;
