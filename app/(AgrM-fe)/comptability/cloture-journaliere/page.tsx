            ...
            <div className="card">
                ...
                >
                    ...
                    <Column
                        ...
                        sortable
                        style={{ width: '7%', textAlign: 'center' }}
                        body={(r: DailyClosing) => (r.statementRequestsCount || 0) + (r.checkbookOrdersCount || 0) + (r.fraisCompteCount || 0) + (r.ouvertureCompteCount || 0)}
                    />
                    <Column
                ...
                {selectedClosing && (
                    <div>
                        ...
                        <div className="flex gap-3 mb-3 flex-wrap">
                            ...
                            {((selectedClosing.ouvertureCompteCount || 0) > 0) && (
                                <Tag value={`Ouverture Compte: ${selectedClosing.ouvertureCompteCount}`} severity="danger" />
                            )}
                        </div>
