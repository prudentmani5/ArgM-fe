...
import { CptCaisse, CptCashCount, CptCompte, CptExercice } from '../types';
...
function CaissePage() {
    ...
    useEffect(() => {
        if (creditDebitData && (creditDebitCallType === 'credit' || creditDebitCallType === 'debit')) {
            ...
            loadCaisses();
            loadInternalAccounts(); // Refresh internal account balances
    ...
    const handleVirement = () => {
        ...
        confirmDialog({
            ...
            accept: () => {
                ...
                if (currentExercice?.exerciceId) params.append('exerciceId', currentExercice.exerciceId);
                fetchVirement({ userAction: getUserAction() }, 'POST', `${BASE_URL}/transfer?${params.toString()}`, 'virement');
            }
        });
    };
                        ...
                        <div className="col-12 md:col-8">
                            <div className="surface-card shadow-1 p-4 border-round" style={{ borderTop: '3px solid #1565C0' }}>
                                ...
                                <Button
                                    ...
                                    disabled={!virementSource || !virementDest || virementMontant <= 0}
                                />
                            </div>
                        </div>
                        <div className="col-12 md:col-4">
                ...
                <TabPanel header="Historique" leftIcon="pi pi-history mr-2">
                    ...
                    >
                        ...
                        <Column
                            ...
                            header="Type"
                            body={(r: CptCashCount) => (
                                <Tag value={r.countType === 'OPENING' ? 'Ouverture' : 'Fermeture'} severity={r.countType === 'OPENING' ? 'info' : 'warning'} />
                            )}
                            sortable
                            style={{ width: '10%' }}
                        />
