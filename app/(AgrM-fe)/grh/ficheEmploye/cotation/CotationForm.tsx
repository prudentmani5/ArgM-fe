    ...
    return (
        <div className="card p-fluid">
            <div className="formgrid grid">
                ...
                <div className="field col-12 md:col-6">
                    <label htmlFor="noteObtenue">
                        Note Obtenue *
                        {selectedNotation && (
                            <span className="text-sm text-500 ml-2">
                                (min: {cotation.nbrPoints1}, max: {cotation.nbrPoints2})
                            </span>
                        )}
                    </label>
                    <InputNumber
                        ...
                        showButtons
                        min={selectedNotation ? cotation.nbrPoints1 : 0}
                        max={selectedNotation ? cotation.nbrPoints2 : undefined}
                        maxFractionDigits={2}
                        minFractionDigits={2}
                        required
                    />
