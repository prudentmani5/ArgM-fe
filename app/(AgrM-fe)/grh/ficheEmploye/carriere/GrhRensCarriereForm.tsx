        ...
        <>
            <div className="card p-fluid">
                <div className="formgrid grid">
                    ...
                    <div className="field col-12 md:col-3">
                        <label htmlFor="calculJrsPreste">Calculer les jours prestés</label>
                        <div className="flex align-items-center">
                            <Checkbox
                                inputId="calculJrsPreste"
                                name="calculJrsPreste"
                                checked={carriere.calculJrsPreste}
                                onChange={handleCheckboxChange}
                            />
                            <label htmlFor="calculJrsPreste" className="ml-2">Oui</label>
                        </div>
                        <small className="p-text-secondary">
                            Si décoché, 30 jours seront utilisés sans calcul des absences
                        </small>
                    </div>
