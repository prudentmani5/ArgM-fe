...
function PaysComponent() {
    ...
    const handleSubmit = () => {
        setBtnLoading(true);
        fetchData(pays, 'Post', buildApiUrl('/api/grh/settings/pays/new'), 'createPays');
        setPays(new Pays());
    };

    const handleSubmitEdit = () => {
        setBtnLoading(true);
        fetchData(paysEdit, 'Put', buildApiUrl(`/api/grh/settings/pays/update/${paysEdit.paysId}`), 'updatePays');
    };
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/pays/findall'), 'loadPays');
    };
