...
function RHFonctionComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(rhfonction, 'Post', buildApiUrl('/api/grh/settings/fonctions/new'), 'createRHFonction');
    }

    const handleSubmitEdit = () => {
        setBtnLoading(true);
        console.log('Data sent to the backend:', rhfonctionEdit);
        fetchData(rhfonctionEdit, 'Put', buildApiUrl(`/api/grh/settings/fonctions/update/${rhfonctionEdit.id}`), 'updateRHFonction');
    }
    ...
    const deleteRHFonction = (id: number) => {
        setBtnLoading(true);
        fetchData(null, 'Delete', buildApiUrl(`/api/grh/settings/fonctions/delete/${id}`), 'deleteRHFonction');
    };
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/fonctions/findall'), 'loadRHFonctions');
    }
