...
function ProvinceComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(province, 'Post', buildApiUrl('/api/grh/settings/provinces/new'), 'createProvince');
    ...
    const handleSubmitEdit = () => {
        ...
        fetchData(provinceEdit, 'Put', buildApiUrl(`/api/grh/settings/provinces/update/${provinceEdit.provinceId}`), 'updateProvince');
    }
