...
function TypeDiplomeComponent() {
    ...
    const handleSubmit = () => {
        setBtnLoading(true);
        fetchData(typeDiplome, 'Post', buildApiUrl('/api/grh/settings/type-diplomes/new'), 'createTypeDiplome');
        setTypeDiplome(new TypeDiplome());
    };

    const handleSubmitEdit = () => {
        setBtnLoading(true);
        fetchData(typeDiplomeEdit, 'Put', buildApiUrl(`/api/grh/settings/type-diplomes/update/${typeDiplomeEdit.typeDiplomeId}`), 'updateTypeDiplome');
    };
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/type-diplomes/findall'), 'loadTypeDiplomes');
    };
