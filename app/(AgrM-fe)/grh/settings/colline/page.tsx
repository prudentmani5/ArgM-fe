...
function CollineComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(colline, 'Post', buildApiUrl('/api/grh/settings/collines/new'), 'createColline');
    ...
    const handleSubmitEdit = () => {
        ...
        fetchData(collineEdit, 'Put', buildApiUrl(`/api/grh/settings/collines/update/${collineEdit.collineId}`), 'updateColline');
    }
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/collines/findall'), 'loadCollines');
    }
