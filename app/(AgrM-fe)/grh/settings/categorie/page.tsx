...
function CategorieComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(categorie, 'Post', buildApiUrl('/api/grh/settings/categories/new'), 'createCategorie');
    ...
    const handleSubmitEdit = () => {
        ...
        fetchData(categorieEdit, 'Put', buildApiUrl(`/api/grh/settings/categories/update/${categorieEdit.categorieId}`), 'updateCategorie');
    }
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/categories/findall'), 'loadCategories');
    }
