...
function CommuneComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(commune, 'Post', buildApiUrl('/api/grh/settings/communes/new'), 'createCommune');
    ...
    const handleSubmitEdit = () => {
        ...
        fetchData(communeEdit, 'Put', buildApiUrl(`/api/grh/settings/communes/update/${communeEdit.communeId}`), 'updateCommune');
    }
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/communes/findall'), 'loadCommunes');
    }

    const loadProvinces = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/provinces/findall'), 'loadProvinces');
    }
