...
function GradeComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(grade, 'Post', buildApiUrl('/api/grh/settings/grades/new'), 'createGrade');
    }

    const handleSubmitEdit = () => {
        setBtnLoading(true);
        console.log('Data sent to the backend:', gradeEdit);
        fetchData(gradeEdit, 'Put', buildApiUrl(`/api/grh/settings/grades/update/${gradeEdit.gradeId}`), 'updateGrade');
    }
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/grades/findall'), 'loadGrades');
    }

    const loadCategories = () => {
        fetchCategories(null, 'Get', buildApiUrl('/api/grh/settings/categories/findall'), 'loadCategories');
    }
