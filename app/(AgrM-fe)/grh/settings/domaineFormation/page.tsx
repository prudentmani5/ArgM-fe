...
function DomaineFormationComponent() {
    ...
    const handleSubmit = () => {
        setBtnLoading(true);
        fetchData(domaine, 'Post', buildApiUrl('/api/grh/settings/domaines/new'), 'createDomaine');
        setDomaine(new DomaineFormation());
    };

    const handleSubmitEdit = () => {
        setBtnLoading(true);
        fetchData(domaineEdit, 'Put', buildApiUrl(`/api/grh/settings/domaines/update/${domaineEdit.domaineId}`), 'updateDomaine');
    };
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/domaines/findall'), 'loadDomaines');
    };
