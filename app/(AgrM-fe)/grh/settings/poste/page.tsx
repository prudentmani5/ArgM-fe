...
const GrhPosteComponent = () => {
    ...
    const handleSubmit = () => {
        ...
        fetchData(grhposte, 'Post', buildApiUrl('/api/grh/settings/postes/new'), 'createGrhPoste');
    };

    const handleSubmitEdit = () => {
        setBtnLoading(true);
        console.log('Data sent to the backend:', grhposteEdit);
        fetchData(grhposteEdit, 'Put', buildApiUrl(`/api/grh/settings/postes/update/${grhposteEdit.posteId}`), 'updateGrhPoste');
    };
    ...
    const deleteGrhPoste = (posteId: string) => {
        setBtnLoading(true);
        fetchData(null, 'Delete', buildApiUrl(`/api/grh/settings/postes/delete/${posteId}`), 'deleteGrhPoste');
    };
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/postes/findall'), 'loadGrhPostes');
    };

    const loadAllRHFonctions = () => {
        fetchRHFonctions(null, 'Get', buildApiUrl('/api/grh/settings/fonctions/findall'), 'loadRHFonctions');
    };
