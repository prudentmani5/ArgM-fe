...
function DepartmentComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(department, 'Post', buildApiUrl('/api/grh/settings/departments/new'), 'createDepartment');
    ...
    const handleSubmitEdit = () => {
        ...
        fetchData(departmentEdit, 'Put', buildApiUrl(`/api/grh/settings/departments/update/${departmentEdit.departmentId}`), 'updateDepartment');
    }
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/departments/findall'), 'loadDepartments');
    }
