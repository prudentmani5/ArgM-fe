...
function SituationComponent() {
    ...
    const handleSubmit = () => {
        setBtnLoading(true);
        fetchData(situation, 'Post', buildApiUrl('/api/grh/settings/situations/new'), 'createSituation');
        setSituation(new Situation());
    };

    const handleSubmitEdit = () => {
        setBtnLoading(true);
        fetchData(situationEdit, 'Put', buildApiUrl(`/api/grh/settings/situations/update/${situationEdit.situationId}`), 'updateSituation');
    };
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/situations/findall'), 'loadSituations');
    };
