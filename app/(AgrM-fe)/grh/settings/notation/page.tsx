...
function NotationComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(notation, 'Post', buildApiUrl('/api/grh/settings/notations/new'), 'createNotation');
    ...
    const handleSubmitEdit = () => {
        ...
        fetchData(notationEdit, 'Put', buildApiUrl(`/api/grh/settings/notations/update/${notationEdit.notationId}`), 'updateNotation');
    }
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/notations/findall'), 'loadNotations');
    }
