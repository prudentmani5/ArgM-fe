...
function TypeCongeComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(typeConge, 'Post', buildApiUrl('/api/grh/settings/type-conges/new'), 'createTypeConge');
    ...
    const handleSubmitEdit = () => {
        ...
        fetchData(typeCongeEdit, 'Put', buildApiUrl(`/api/grh/settings/type-conges/update/${typeCongeEdit.typeCongeId}`), 'updateTypeConge');
    }
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/type-conges/findall'), 'loadTypeConges');
    }
