...
function ServiceComponent() {
    ...
    const handleSubmit = () => {
        ...
        fetchData(service, 'Post', buildApiUrl('/api/grh/settings/services/new'), 'createService');
    ...
    const handleSubmitEdit = () => {
        ...
        fetchData(serviceEdit, 'Put', buildApiUrl(`/api/grh/settings/services/update/${serviceEdit.serviceId}`), 'updateService');
    }
    ...
    const loadAllData = () => {
        fetchData(null, 'Get', buildApiUrl('/api/grh/settings/services/findall'), 'loadServices');
    }

    const loadAllDepartments = () => {
        fetchDepartments(null, 'Get', buildApiUrl('/api/grh/settings/departments/findall'), 'loadDepartments');
    }
