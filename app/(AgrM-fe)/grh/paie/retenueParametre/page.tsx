...
function RetenueParametreComponent() {
    ...
    const reportFromPeriodToAnotherBodyTemplate = (rowData: RetenueParametre) => {
        return (
            <span className={`p-badge ${rowData.reportFromPeriodToAnother ? 'p-badge-success' : 'p-badge-secondary'}`}>
                {rowData.reportFromPeriodToAnother ? 'Oui' : 'Non'}
            </span>
        );
    };
                        ...
                        <div className='col-12'>
                            <div className='card'>
                                ...
                                >
                                    ...
                                    />
                                    <Column
                                        field="reportFromPeriodToAnother"
                                        header="Reporter d'une période à l'autre"
                                        body={reportFromPeriodToAnotherBodyTemplate}
                                        sortable
                                    />
