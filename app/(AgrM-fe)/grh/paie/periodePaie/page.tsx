                            ...
                            <Card title="Migration des données de paie" subTitle="Reporter les données d'une période clôturée vers une période ouverte">
                                ...
                                <div className="mt-4">
                                    ...
                                    <ul className="line-height-3">
                                        <li>Seules les retenues dont le paramètre <strong>"Reporter d'une période à l'autre"</strong> est activé seront copiées vers la nouvelle période. Les autres seront clôturées.</li>
                                        <li>Seules les indemnités dont le paramètre <strong>"Reporter d'une période à l'autre"</strong> est activé seront copiées vers la nouvelle période.</li>
                                        <li>Seules les primes dont le paramètre <strong>"Reporter d'une période à l'autre"</strong> est activé seront copiées vers la nouvelle période.</li>
                                    </ul>
