    ...
    return (
        <div className="card p-fluid">
            <div className="formgrid grid">
                ...
                <div className="field col-12 md:col-3">
                    <label htmlFor="hasJustifiedExit">Sortie Justifiée</label>
                    <div className="flex align-items-center">
                        <Checkbox
                            inputId="hasJustifiedExit"
                            name="hasJustifiedExit"
                            checked={pointage.hasJustifiedExit ?? false}
                            onChange={handleCheckboxChange}
                        />
                        <label htmlFor="hasJustifiedExit" className="ml-2">
                            {pointage.hasJustifiedExit ? 'Oui' : 'Non'}
                        </label>
                    </div>
                </div>

                <div className="field col-12 md:col-3">
                    <label htmlFor="hasALeave">En Congé</label>
                    <div className="flex align-items-center">
                        <Checkbox
                            inputId="hasALeave"
                            name="hasALeave"
                            checked={pointage.hasALeave ?? false}
                            onChange={handleCheckboxChange}
                        />
                        <label htmlFor="hasALeave" className="ml-2">
                            {pointage.hasALeave ? 'Oui' : 'Non'}
                        </label>
                    </div>
                </div>

                <div className="field col-12 md:col-3">
                    <label htmlFor="hasJustifiedRetard">Retard Justifié</label>
                    <div className="flex align-items-center">
                        <Checkbox
                            inputId="hasJustifiedRetard"
                            name="hasJustifiedRetard"
                            checked={pointage.hasJustifiedRetard ?? false}
                            onChange={handleCheckboxChange}
                        />
                        <label htmlFor="hasJustifiedRetard" className="ml-2">
                            {pointage.hasJustifiedRetard ? 'Oui' : 'Non'}
                        </label>
                    </div>
                </div>
