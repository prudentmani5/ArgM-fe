            ...
            <div className="formgrid grid">
                ...
                <div className="field col-12 md:col-3">
                    ...
                    <Calendar
                        id="dateDebutD"
                        name="dateDebutD"
                        value={stringToDate(horaireDates.dateDebutD)}
                ...
                <div className="field col-12 md:col-3">
                    ...
                    <Calendar
                        id="dateFinD"
                        name="dateFinD"
                        value={stringToDate(horaireDates.dateFinD)}
                        onChange={handleCalendarChange}
                        showIcon
                        dateFormat="dd/mm/yy"
                    ...
                    <div className="card bg-blue-50 p-3 mb-3">
                        ...
                        <div className="grid">
                            <div className="col-12 md:col-4">
                                <p><strong>Matricule:</strong> {currentEmployeeData.horaire?.matriculeId || matricule}</p>
                            </div>
                            <div className="col-12 md:col-4">
                    ...
                    <div className="grid">
                        <div className="col-12 md:col-6">
                            {currentEmployeeData.horaire ? (
                                ...
                                <div className="card bg-yellow-50 p-3">
                                    <h5 className="text-yellow-800 mb-2">
                                        <i className="pi pi-info-circle mr-2"></i>
                                        Aucun Horaire Existant
                                    </h5>
                                    <p className="text-yellow-700">
                                        Cet employé n'a pas encore d'horaire. Sélectionnez un groupe et des dates pour en créer un.
                                    </p>
                                    {currentEmployeeData.serviceId && (
                                        <p><strong>Service (carrière):</strong> {currentEmployeeData.serviceId}</p>
                                    )}
                                </div>
                            )}
                        </div>
                        <div className="col-12 md:col-6">
                            <div className="card bg-green-50 p-3">
                                <h5 className="text-green-800 mb-2">
                                    ...
                                    {currentEmployeeData.horaire ? 'Nouveau Horaire' : 'Créer Horaire'}
                                </h5>
                                <p><strong>Service:</strong> {currentEmployeeData.horaire?.serviceId || currentEmployeeData.serviceId || '-'}</p>
                                <p><strong>{currentEmployeeData.horaire ? 'Nouveau Groupe' : 'Groupe'}:</strong>
                                    <span className="text-green-700 font-bold">
                                        {selectedGroupeId ? getGroupeLabel(selectedGroupeId) : 'Sélectionnez un groupe'}
                                    </span>
                                </p>
                                <p><strong>{currentEmployeeData.horaire ? 'Nouvelle Période' : 'Période'}:</strong>
                                    {horaireDates.dateDebutD && horaireDates.dateFinD ?
                                        ` ${stringToDate(horaireDates.dateDebutD)?.toLocaleDateString('fr-FR')} - ${stringToDate(horaireDates.dateFinD)?.toLocaleDateString('fr-FR')}` :
                                        ' Sélectionnez les dates'
                                    }
                                </p>
                                <p><strong>Numéro Ordre:</strong> <span className="text-green-700">Sera généré automatiquement</span></p>
                            </div>
                        </div>
                    </div>
