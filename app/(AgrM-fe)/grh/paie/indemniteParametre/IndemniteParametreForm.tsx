        ...
        <div className="card p-fluid">
            <div className="formgrid grid">
                ...
                <div className="field col-4 md:col-4">
                    <div className="flex align-items-center">
                        <Checkbox
                            inputId="reportFromPeriodToAnother"
                            checked={indemniteParametre.reportFromPeriodToAnother}
                            onChange={(e) => handleCheckboxChange('reportFromPeriodToAnother', e.checked || false)}
                        />
                        <label htmlFor="reportFromPeriodToAnother" className="ml-2">Reporter d'une période à l'autre</label>
                    </div>
                </div>
                <div className="field col-4 md:col-4">
