...
const RapportSortiesPage: React.FC = () => {
      ...
      const grouped = response.data.reduce((acc: RapportSortieGrouped[], item: RapportSortie) => {
        ...
        if (existingGroup) {
          ...
          acc.push({
            ...
            serviceLibelle: item.serviceLibelle || 'N/A',
            dateSortie: item.dateSortie, // On garde la date pour référence mais le groupement est par service
            totalSorties: 1,
  ...
  const expandedRowTemplate = (rowData: RapportSortieGrouped) => {
    return (
      <div className="p-3">
        <div className="mb-3">
          <h4>Détails du Service {rowData.serviceLibelle}</h4>
    ...
    <div className="flex justify-content-between align-items-center mb-3">
      ...
      <span className="p-input-icon-left" style={{ width: '40%' }}>
        ...
        <InputText
          ...
          placeholder="Rechercher par service ou montant..."
          className="w-full"
        />
      </span>
      <Button
