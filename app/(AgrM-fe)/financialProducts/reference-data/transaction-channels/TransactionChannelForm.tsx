                ...
                <div className="grid">
                    ...
                    <div className="col-12 md:col-6">
                        ...
                        <InputText
                            id="nameFr"
                            name="nameFr"
                            value={transactionChannel.nameFr}
                            onChange={handleChange}
                            required
                            maxLength={100}
                        />
                    ...
                    <div className="col-12 md:col-6">
                        ...
                        <InputTextarea
                            id="description"
                            name="description"
                            value={transactionChannel.description || ''}
                            onChange={handleChange}
                            rows={3}
                        />
                    </div>
                    <div className="col-12 md:col-6">
                        ...
                        <InputTextarea
                            id="descriptionFr"
                            name="descriptionFr"
                            value={transactionChannel.descriptionFr || ''}
                            onChange={handleChange}
                            rows={3}
                        />
                    </div>
                    <div className="col-12 md:col-6">
                        <div className="field-checkbox mt-4">
                            <Checkbox
                                inputId="isActive"
                                checked={transactionChannel.isActive}
