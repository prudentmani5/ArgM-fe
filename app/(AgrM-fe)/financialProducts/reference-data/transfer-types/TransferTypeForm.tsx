...
interface TransferTypeFormProps {
    transferType: TransferType;
    handleChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => void;
    handleCheckboxChange: (name: string, checked: boolean) => void;
}

const TransferTypeForm: React.FC<TransferTypeFormProps> = ({
    transferType,
    handleChange,
                ...
                <div className="grid">
                    ...
                    <div className="col-12 md:col-6">
                        ...
                        <InputTextarea
                            id="description"
                            name="description"
                            value={transferType.description || ''}
                            onChange={handleChange}
                            rows={3}
                        />
                    </div>
                    <div className="col-12 md:col-6">
                        ...
                        <InputTextarea
                            id="descriptionFr"
                            name="descriptionFr"
                            value={transferType.descriptionFr || ''}
                            onChange={handleChange}
                            rows={3}
                        />
                    </div>
