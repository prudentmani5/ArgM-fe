...
interface CompteResultatFormProps {
  dateReference: string;
  setDateReference: (date: string) => void;
  etatEcritures: string; // "validees" | "nonValidees" | "toutes"
  setEtatEcritures: (etat: string) => void;
  typeCompteResultat: string; // "exploitation" | "general"
  setTypeCompteResultat: (etat: string) => void;
  handleSubmit: () => void;
}

const CompteResultatForm: React.FC<CompteResultatFormProps> = ({
  dateReference,
  setDateReference,
  etatEcritures,
  setEtatEcritures,
  typeCompteResultat,
  setTypeCompteResultat,
  handleSubmit
}) => {
  return (
