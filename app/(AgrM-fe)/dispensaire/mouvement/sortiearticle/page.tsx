...
export default function StkSortiePage() {
    ...
    const loadDropdownData = async () => {
        try {
            ...
            const endpoints = [
                ...
                { url: `${API_BASE_URL}/stkMagasinResponsables/findall`, setter: setMagResponsables },
                { url: `${API_BASE_URL}/stkServiceResponsables/findall`, setter: setServResponsables },
    ...
    const checkNumeroPiece = async (numeroPiece: string): Promise<boolean> => {
        try {
            const response = await axios.get(`${BASE_URL}/exists?numeroPiece=${numeroPiece}`);
