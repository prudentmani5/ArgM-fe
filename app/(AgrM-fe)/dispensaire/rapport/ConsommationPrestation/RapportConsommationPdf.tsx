    ...
    <Document>
      <Page size="A4" style={styles.page} orientation="landscape">
        <View style={styles.header}>
          <Text style={styles.title}>Rapport des Consommations par Prestation</Text>
...
{data.map((group, index) => (
    <View key={index} style={{ marginBottom: 15 }}>
        <Text style={{ fontWeight: 'bold', marginBottom: 5 }}>
            Prestation: {group.prestationId} - {group.libellePrestation} | 
        ...
        <View style={styles.table}>
            <View style={styles.tableHeader}>
                ...
                <Text style={styles.tableColHeader}>Nom Employé</Text>
                <Text style={styles.tableColHeader}>Prénom Employé</Text>
                <Text style={styles.tableColHeader}>Date</Text>
                <Text style={styles.tableColHeader}>Type</Text>
                <Text style={styles.tableColHeader}>Partenaire</Text>
