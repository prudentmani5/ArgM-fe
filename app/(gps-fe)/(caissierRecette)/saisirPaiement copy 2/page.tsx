...
function EntryPayementComponent() {
    ...
    // Fonction d'impression avec informations bancaires
    const handlePrint = () => {
        if (!lastSavedEntry) return;
        
        // Récupérer les informations de banque et compte bancaire
        const selectedBank = banks.find(bank => bank.banqueId === lastSavedEntry.banqueId);
        const selectedAccount = bankAccounts.find(account => 
            account.compteBanqueId === lastSavedEntry.compteBanqueId
        );
                    ...
                    <body>
                        <div class="receipt">
                            ...
                            <div class="receipt-info">
                                <div class="field">
                                    <span class="label">Numéro Facture:</span> ${lastSavedEntry.factureId || 'N/A'}
                                </div>
                                <div class="field">
                                    <span class="label">Client:</span> ${lastSavedEntry.clientNom || 'N/A'}
                                </div>
                                <div class="field">
                                    <span class="label">Montant:</span> ${new Intl.NumberFormat('fr-FR', { style: 'currency', currency: 'BIF' }).format(lastSavedEntry.montantPaye || 0)}
                                </div>
                                <div class="field">
                                    <span class="label">Mode de paiement:</span> ${getPaymentModeLabel(lastSavedEntry.modePaiement) || 'N/A'}
                                </div>
                                <div class="field">
                                    <span class="label">Date:</span> ${new Date(lastSavedEntry.datePaiement || new Date()).toLocaleString()}
                                </div>
                                <div class="field">
                                    <span class="label">Bordereau:</span> ${lastSavedEntry.reference || 'N/A'}
                                </div>
                                ...
                                <div class="bank-section">
                                    ...
                                    <div class="field">
                                        <span class="label">Banque:</span> ${selectedBank?.libelleBanque || 'N/A'}
                                    </div>
                                    <div class="field">
                                        <span class="label">Numéro de compte:</span> ${selectedAccount?.numeroCompte || 'N/A'}
                                    </div>
                                    <div class="field">
                                        <span class="label">Type de transaction:</span> ${getPaymentModeLabel(lastSavedEntry.modePaiement) || 'N/A'}
                                    </div>
