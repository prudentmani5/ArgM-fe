export class Invoice {
    ...
    montMagasinage37: number;
    montGardienage37: number;
    ...
    constructor() {
        ...
        // Extended period amounts
        this.montMagasinage37 = 0;
        this.montGardienage37 = 0;
...
export class ManutentionResult {
    ...
    montantGardiennage37: number;
    montantMagasinage: number;
    montantMagasinage37: number;
    facture: string;
    lt: string;
    redv: number;
    ...
    constructor() {
        ...
        this.montantGardiennage37 = 0;
        this.montantMagasinage = 0;
        this.montantMagasinage37 = 0;
        this.facture = '';
        this.lt = '';
        this.redv = 0;
