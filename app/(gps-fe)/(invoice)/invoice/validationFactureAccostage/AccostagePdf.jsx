...
export const AccostagePdf = ({ accostage, isProforma = false }) => {

       // Conversion du montant total en lettres
    const montTotalEnLettres = accostage.taxeAccostage + accostage.taxeManut + accostage.montantRedev + accostage.montRedevTaxe + accostage.montTVA
        ? nombreEnLettres(Math.floor(accostage.taxeAccostage + accostage.taxeManut + accostage.montantRedev + accostage.montRedevTaxe + accostage.montTVA)) + ' francs burundais'
        ...
        <Page size="A4" style={styles.page}>
            <View style={{ marginTop: 10, flexDirection: 'row', justifyContent: 'flex-start', fontSize: 9 }}>
                <View style={{ textAlign: 'left' }}>
                    ...
                    <Text>RAISON SOCIALE: {accostage.nomImportateur}</Text>
            ...
            <View style={styles.section}>
                <View style={{ textAlign: 'center' }}>
                    <Text>{isProforma ? 'Facture Proforma Accostage' : 'Facture Accostage'} No {accostage.noArrive}, le {new Date().toLocaleDateString('fr-FR')}</Text>
                    <Text>_____________________________________________</Text>
                </View>
                
                <View style={styles.espacement}></View>
                <View style={{ alignItems: 'center' , fontSize: 9}}>
                    <Text style={styles.label}>Importateur: {accostage.nomImportateur}</Text>
                    <Text style={styles.label}>Lettre de Transport: {accostage.lettreTransp}</Text>
                    <Text style={styles.label}>Barge: {accostage.nomBarge}</Text>
                </View>
                ...
                <View style={{ alignItems: 'center', fontSize: 9 }}>      
                    <View style={styles.row}>
                        <Text style={styles.label}>Numéro Arrivée:</Text>
                        <Text style={styles.value}>{accostage.noArrive}</Text>
                    </View>
                    
                    <View style={styles.row}>
                        <Text style={styles.label}>Date Arrivée:</Text>
                        <Text style={styles.value}>{formatDate(accostage.dateArrive)|| '-'}</Text>
                    </View>
                    
                    <View style={styles.row}>
                        <Text style={styles.label}>Date Départ:</Text>
                        <Text style={styles.value}>{formatDate(accostage.dateDepart) || '-'}</Text>
                    </View>
                    
                    <View style={styles.row}>
                        <Text style={styles.label}>Taxe Accostage:</Text>
                        <Text style={styles.value}>
                            {formatCurrency(accostage.taxeAccostage)}
                        </Text>
                    </View>
                    
                    <View style={styles.row}>
                        <Text style={styles.label}>Taxe Manutention:</Text>
                        <Text style={styles.value}>
                            {formatCurrency(accostage.taxeManut)}
                        </Text>
                    </View>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={styles.value}>
                            {formatCurrency(accostage.montantRedev)}
                        </Text>
                    </View>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={styles.value}>
                            {formatCurrency(accostage.montRedevTaxe)}
                        </Text>
                    </View>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={styles.value}>
                            {formatCurrency(accostage.montTVA)}
                        </Text>
                    </View>
          ...
          <View style={styles.totalRow}>
            ...
            <Text style={styles.value}>{formatCurrency(accostage.taxeAccostage + accostage.taxeManut + accostage.montantRedev + accostage.montRedevTaxe + accostage.montTVA)}</Text>
          </View>
