...
export default function ValidInvoicePage() {
    ...
    const loadValidatedInvoices = () => {
        fetchData(null, 'GET', buildApiUrl('/invoices/validated-with-payment-status'), 'loadValidated');
    };
                ...
                <TabPanel header="Factures Validées">
                    ...
                    >
                        ...
                        />
                         ...
                         {/* Ajouter la colonne Statut d'Encaissement */}
                        <Column 
                            field="statutEncaissement" 
                            header="Statut Encaissement" 
                            sortable
                            body={(rowData) => (
                                <span 
                                    className={`font-bold ${
                                        rowData.statutEncaissement === 'Encaisse' 
                                            ? 'text-green-600' 
                                            : 'text-red-600'
                                    }`}
                                >
                                    {rowData.statutEncaissement || 'Non Encaisse'}
                                </span>
                            )}
                        />
                        <Column field="StatutEncaissement" header="Statut Encaissement" sortable />
                    </DataTable>
