...
interface StkEntreeFormProps {
    ...
    addDetail: () => void;
    removeDetail: (index: number, entreeDetailsId?: number, articleLibelle?: string) => void; // Ajouté articleLibelle
...
const StkEntreeForm: React.FC<StkEntreeFormProps> = ({
    ...
    const confirmDelete = (rowIndex: number, rowData: StkEntreeDetails) => {
        ...
        confirmDialog({
            message: `Êtes-vous sûr de vouloir supprimer ${articleName} ? Cette action est irréversible.`,
            header: 'Confirmation de suppression',
            icon: 'pi pi-exclamation-triangle',
            acceptClassName: 'p-button-danger',
            accept: () => {
                // Appeler la fonction de suppression avec l'ID et le nom
                removeDetail(rowIndex, rowData.entreeDetailsId, articleName);
            },
            reject: () => {
                        ...
                        <Column header="Action" 
                            body={(rowData, { rowIndex }) => (
                                <Button 
                                    ...
                                    onClick={() => confirmDelete(rowIndex, rowData)}
