      ...
      const grouped = response.data.reduce((acc: RapportConsommationGrouped[], item: RapportConsommation) => {
        ...
        if (existingGroup) {
          ...
          acc.push({
            ...
            nomEmploye: `${item.nom} ${item.prenom}`.trim(),
    ...
    <>
      ...
      <TabView activeIndex={activeIndex} onTabChange={tableChangeHandle}>
        <TabPanel header="Générer Rapport Consommation">
          <Card title="Paramètres du rapport de consommation journalière">
      ...
      <Dialog
        //header={`Rapport des Consommations`}
           header={
    <div>
      <div>Rapport des Consommations externes</div>
      ...
      >
        <div className="card">
          ...
          >
            ...
            <Column field="nomEmploye" header="Employé" sortable />
            <Column 
