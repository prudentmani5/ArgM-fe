...
const RapportConsommationPage: React.FC = () => {
  ...
  const fetchRapport = async (params: RapportConsommationParams) => {
    ...
    try {
      ...
      // Grouper par prestation au lieu de matricule
      const grouped = response.data.reduce((acc: RapportConsommationGrouped[], item: RapportConsommation) => {
        const existingGroup = acc.find(group => group.prestationId === item.prestationId);
        if (existingGroup) {
          ...
          acc.push({
            ...
            libellePrestation: item.libellePrestation || 'Non spécifié',
    ...
    return (
      <div className="p-3">
        <DataTable value={rowData.items} responsiveLayout="scroll" size="small">
          ...
          <Column field="nom" header="Nom Employé" />
          <Column field="prenom" header="Prénom Employé" />
          ...
          <Column field="libelle" header="Partenaire" />
    ...
    <div className="flex justify-content-between align-items-center mb-3">
      ...
      <span className="p-input-icon-left" style={{ width: '40%' }}>
        ...
        <InputText
          ...
          placeholder="Rechercher par prestation ou montant..."
          className="w-full"
        />
      </span>
      <Button
        ...
        onClick={() => {
          if (expandedRows) {
            ...
            groupedData.forEach(data => {
              expanded[data.prestationId] = true;
            });
    ...
    <>
      ...
      <TabView activeIndex={activeIndex} onTabChange={tableChangeHandle}>
        <TabPanel header="Générer Rapport Consommation">
          <Card title="Paramètres du rapport de consommation par prestation">
      ...
      >
        <div className="card">
          ...
          >
            ...
            <Column field="prestationId" header="ID Prestation" sortable />
            <Column field="libellePrestation" header="Prestation" sortable />
            <Column
