-- ========================================
-- REPLACE COMMUNES DATA
-- République du Burundi - 42 Communes
-- ========================================

-- 1. Delete all existing communes
DELETE FROM communes;

-- 2. Insert communes by province
...
--   - GITEGA: 9 communes
--
-- Adjust column names if your table structure is different:
--   - commune_id instead of code
--   - nom instead of name
--   - province instead of province_id
-- ========================================
